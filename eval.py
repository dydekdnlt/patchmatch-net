...
def filter_depth(args, scan: str = ""):
    ...
    for ref_view, src_views in pair_data:
        ...
        photo_mask = (confidence > args.photo_thres).squeeze(2) # photo_thres = 0.8
        ...
        geo_mask = geo_mask_sum >= args.geo_mask_thres # geo_mask_thres = 3
...
if __name__ == "__main__":
    ...
    parser.add_argument("--geo_mask_thres", type=int, default=3, help="threshold for geometric consistency filtering")
    parser.add_argument("--photo_thres", type=float, default=0.8,
